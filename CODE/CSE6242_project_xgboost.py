...
#Feature selections using Xgboost with first 0.1 million data
...
# Training the entire data set using Xgboost
...
#set max_depth 3, 5, 10 and base_score 0.005, 0.05
clf = XGBClassifier(max_depth=10, base_score=0.005)
